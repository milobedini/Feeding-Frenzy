...
const shark1 = new Shark(8, 4, 250, "shark")
const shark2 = new Shark(10, 9, 250, "shark")
const shark3 = new Shark(5, 12, 250, "shark")
const shark4 = new Shark(18, 3, 250, "shark")
const shark5 = new Shark(22, 6, 150, "shark")
const shark6 = new Shark(2, 2, 200, "shark")
const shark7 = new Shark(16, 17, 100, "shark")
...
const shark17 = new Shark(10, 10, 100, "shark")
const shark18 = new Shark(8, 8, 100, "shark")
const shark19 = new Shark(21, 11, 100, "shark")
const shark20 = new Shark(4, 6, 100, "shark")
...
function startGameFinal() {
  gameTimer = setInterval(() => {
    ...
    shark17.interaction()
    shark18.move(timeSig)
    shark18.interaction()
    shark19.move(timeSig)
    shark19.interaction()
    shark20.move(timeSig)
    shark20.interaction()
